...
## get the school reference
    ...
    if (in_array('wcp_school', (array)$current_user->roles)) {
        ...
        <table id="teacher___table">
            ...
            $schoolDetailFromSchoolTable = $WCP_Common_School_Model->get_school_by_wp_user_id($current_user->id);
            $teacher_list = $WCP_Common_Teacher_Model->get_teacher_by_school_id($schoolDetailFromSchoolTable->id);
        ...
        <div id="registerBox" class="wcp-form-box">
            ...
            <form method="POST"
                ...
                <input type="hidden" name="school_reference"
                       value="<?php echo base64_encode($schoolDetailFromSchoolTable->id) ?>">
